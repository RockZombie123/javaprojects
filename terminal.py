...
elif ans == 'Delete Facebook image':
          print('Deleting facebook.ico...')
          os.system('rm facebook.ico')


elif ans == 'bastet' or ans == 'Bastet':
	print('Bastet is being installed by linux...')
	os.system('sudo apt install bastet')

elif ans == 'Delete Bastet' or 'delete bastet':
	print('Deleting bastet...')
	os.system('sudo apt remove bastet')
